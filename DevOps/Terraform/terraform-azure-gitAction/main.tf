...
#   name     = "storagegroupivo"
#   location = var.resource_group_location
# }

# resource "azurerm_storage_account" "saivo" {
#   name                     = "storageaccivo"
...
# resource "azurerm_storage_container" "scivo" {
#   name                  = "taskboardcontainerivo"
#   storage_account_name  = azurerm_storage_account.saivo.name
# }
